...
try {
  ...
  check('tools/list: 23 tools incl. fx_gates', { result: { content: [{ text: names.join(',') }] } }, (t) => ['fx_form', 'fx_field', 'fx_answer', 'fx_scroll', 'fx_gates'].every((n) => t.includes(n)) && t.split(',').length === 23);
